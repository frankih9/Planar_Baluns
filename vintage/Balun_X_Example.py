...
max_tracks = VC.max_tracks(balunLength, trackWidth, trackSpacing, 'X')
...
if max_tracks >= (int(primaryTurns) + int(secondaryTurns)) and ratio_valid:
    ...
    ################################
    Balun_X_Build(balunLength, trackWidth, trackSpacing, int(primaryTurns), int(secondaryTurns), C_Name = Cell_Name)
