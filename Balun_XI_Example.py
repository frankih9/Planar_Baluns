...
max_tracks = VC.max_tracks(balunLength, trackWidth, trackSpacing, 'XI')
...
if max_tracks >= (int(primaryTurns) + int(secondaryTurns)) and ratio_valid:
    ...
    #################################
    Balun_XI_Build(balunLength, trackWidth, trackSpacing, int(primaryTurns), int(secondaryTurns), C_Name = Cell_Name)
